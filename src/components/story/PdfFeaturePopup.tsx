...
const PdfFeaturePopup = ({ userId }: PdfFeaturePopupProps) => {
  ...
  return (
    <Dialog open={open} onOpenChange={(v) => { if (!v) handleClose(); }}>
      <DialogContent className="max-w-[360px] rounded-3xl border-2 border-white/30 bg-gradient-to-b from-purple-50 via-pink-50 to-orange-50 p-0 overflow-hidden" dir="rtl">
        {/* Decorative top bar */}
