      ...
      >
        <div className="p-5">
              ...
              <span className="text-xl font-black">
                {hasDiscount && (
                  <span className="line-through opacity-50 text-sm mx-1 font-bold">
                    ₪{tier.id === "full" ? "119.90" : originalPrice.toFixed(2)}
                  </span>
                )}
                ₪{(tier.id === "full" && !hasDiscount) ? "119.90" : Number(finalPrice).toFixed(2)}
              </span>
          ...
          <div className="flex flex-col gap-2">
            ...
            >
              אישור ורכישה ₪{(tier.id === "full" && !hasDiscount) ? "119.90" : Number(finalPrice).toFixed(2)} ✨
            </Button>
