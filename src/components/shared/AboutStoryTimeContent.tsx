...
export const AboutStoryTimeContent = () => {
  return (
    <div className="space-y-4 text-sm text-foreground/90 leading-relaxed" dir="rtl">
      ...
      <p>🛡️ <strong>כלים להתמודדות ועיבוד:</strong> האפליקציה כוללת נושאים מובנים שיעזרו לכם ולילדכם לצלוח <p>🛡️ <strong>כלים להתמודדות ועיבוד:</strong> האפליקציה כוללת נושאים מובנים שיעזרו לכם ולילדכם לצלוח סיטואציות מאתגרות בבית, בגן או בבית הספר. ניתן לחבר סיפור על כל נושא שקרה באותו יום, לגרום לילד להזדהות עם הגיבור ולגעת בבעיה בצורה רכה ומעצימה.</p>. ניתן לחבר סיפור על כל נושא שקרה באותו יום, לגרום לילד להזדהות עם הגיבור ולגעת בבעיה בצורה רכה ומעצימה.</p>
