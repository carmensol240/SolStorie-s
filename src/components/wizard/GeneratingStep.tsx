        ...
        <div className="flex-1 flex flex-col items-center justify-center px-4 pb-6 mt-4">
          <div className="w-full max-w-sm bg-white/80 backdrop-blur-md rounded-2xl p-5 shadow-lg border border-purple-100/50 space-y-3">
            ...
            <button
              type="button"
              disabled
              className="w-full flex items-center justify-center gap-2 py-2.5 px-4 bg-white border border-gray-300 rounded-xl shadow-sm transition-all text-sm font-bold text-gray-700 opacity-50 cursor-not-allowed"
            >
