...
export const CHARACTER_SECTIONS: CharacterSection[] = [
  ...
  },
  {
    ...
    topics: [
      ...
      { id: "eating-with-cutlery-edu", label: "🍴 לאכול עם סכו״ם – הכלים המבריקים שלי", description: "סיפור העצמה חברתי: כשאני אוכל/ת עם כף ומזלג, הידיים שלי נשארות נקיות והאוכל מגיע בדיוק לפה. זה מרגיש גדול ומיוחד!", image: topicBraveTaster, ageRange: "2-6", keywords: ["אכילה", "סכום", "כלי אוכל", "עצמאות"] },
