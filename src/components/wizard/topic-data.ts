...
export const CHARACTER_SECTIONS: CharacterSection[] = [
  ...
  },
  {
    ...
    topics: [
      ...
      { id: "letter-dalet", label: "אות ד׳ – הדלת הסודית", description: "סיפור על דלת סודית שמאחוריה מחכים דברים מדהימים — דובדבנים, דגים ודמיון.", image: topicMagicCastle, ageRange: "3-6", keywords: ["אות ד", "אלף בית", "למידה"], subCategory: "🔤 אותיות" },
      { id: "letter-he", label: "אות ה׳ – ההרפתקה בהר", description: "הילד/ה מטפס/ת על הר גבוה ופוגש/ת היפופוטם, הגיע הזמן להכיר את האות ה׳.", image: topicCloudAdventure, ageRange: "3-6", keywords: ["אות ה", "אלף בית", "למידה"], subCategory: "🔤 אותיות" },
      { id: "letter-vav", label: "אות ו׳ – הוורד הוורוד", description: "סיפור על גינה של ורדים ורודים, וילונות וותיקים — והאות ו׳ שמחברת את הכל.", image: topicMagicalForest, ageRange: "3-6", keywords: ["אות ו", "אלף בית", "למידה"], subCategory: "🔤 אותיות" },
      { id: "letter-zayin", label: "אות ז׳ – הזיקית הזריזה", description: "הרפתקה עם זיקית שמשנה צבעים, זברה זזה וזיקוקים — כולם מתחילים באות ז׳.", image: topicZooAdventure, ageRange: "3-6", keywords: ["אות ז", "אלף בית", "למידה"], subCategory: "🔤 אותיות" },
      { id: "letter-chet", label: "אות ח׳ – החתול החמוד", description: "סיפור על חתול חמוד שאוהב חלב, חלומות וחברים — והאות ח׳ מלווה אותו בכל מקום.", image: topicFriendship, ageRange: "3-6", keywords: ["אות ח", "אלף בית", "למידה"], subCategory: "🔤 אותיות" },
      { id: "letter-tet", label: "אות ט׳ – הטיול הטעים", description: "הילד/ה יוצא/ת לטיול וטועם/ת טעמים חדשים — תפוחים, תותים וטירמיסו עם האות ט׳.", image: topicFamilyTrip, ageRange: "3-6", keywords: ["אות ט", "אלף בית", "למידה"], subCategory: "🔤 אותיות" },
      { id: "letter-yod", label: "אות י׳ – הילד/ה היצירתי/ת", description: "סיפור על ילד/ה שמכיר/ה את האות י׳ — יער, ירח, ים ויצירה.", image: topicCloudAdventure, ageRange: "3-6", keywords: ["אות י", "אלף בית", "למידה"], subCategory: "🔤 אותיות" },
      { id: "letter-kaf", label: "אות כ׳ – הכוכב הכחול", description: "הרפתקה בחלל עם כוכב כחול, כדור ארץ וכנפיים — האות כ׳ מאירה את הדרך.", image: topicSpaceHero, ageRange: "3-6", keywords: ["אות כ", "אלף בית", "למידה"], subCategory: "🔤 אותיות" },
      { id: "letter-lamed", label: "אות ל׳ – הלב הלוהט", description: "סיפור על לב גדול שמלא באהבה, לבבות ולחישות — כולם עם האות ל׳.", image: topicSuperheroes, ageRange: "3-6", keywords: ["אות ל", "אלף בית", "למידה"], subCategory: "🔤 אותיות" },
      { id: "letter-mem", label: "אות מ׳ – המלך המצחיק", description: "מלך מצחיק עם משקפיים, מטריה ומפתח — כל מילה מתחילה באות מ׳.", image: topicMagicCastle, ageRange: "3-6", keywords: ["אות מ", "אלף בית", "למידה"], subCategory: "🔤 אותיות" },
      { id: "letter-nun", label: "אות נ׳ – הנסיכה הנועזת", description: "נסיכה נועזת עם נר, נמלים ונהר — הרפתקה עם האות נ׳.", image: topicMagicCastle, ageRange: "3-6", keywords: ["אות נ", "אלף בית", "למידה"], subCategory: "🔤 אותיות" },
      { id: "letter-samekh", label: "אות ס׳ – הסוס הסוער", description: "סוס סוער דוהר בסערה, עובר ליד ספינה וסלעים — האות ס׳ בכל מקום.", image: topicZooAdventure, ageRange: "3-6", keywords: ["אות ס", "אלף בית", "למידה"], subCategory: "🔤 אותיות" },
      { id: "letter-ayin", label: "אות ע׳ – העץ הענק", description: "עץ ענק עם ענפים, עלים ועוגיות — סיפור על האות ע׳ שגדלה עם הטבע.", image: topicMagicalForest, ageRange: "3-6", keywords: ["אות ע", "אלף בית", "למידה"], subCategory: "🔤 אותיות" },
      { id: "letter-pe", label: "אות פ׳ – הפרפר הפלאי", description: "פרפר פלאי עם פרחים, פיל ופנס — הכל מתחיל באות פ׳.", image: topicMagicalForest, ageRange: "3-6", keywords: ["אות פ", "אלף בית", "למידה"], subCategory: "🔤 אותיות" },
      { id: "letter-tsadi", label: "אות צ׳ – הצב הצבעוני", description: "צב צבעוני צועד לאט ופוגש ציפור, צדפים וצעצועים — כולם עם אות צ׳.", image: topicZooAdventure, ageRange: "3-6", keywords: ["אות צ", "אלף בית", "למידה"], subCategory: "🔤 אותיות" },
      { id: "letter-qof", label: "אות ק׳ – הקוף הקטן", description: "קוף קטן וקסום שאוהב קרקס, קשת וקליפות — הרפתקה עם האות ק׳.", image: topicZooAdventure, ageRange: "3-6", keywords: ["אות ק", "אלף בית", "למידה"], subCategory: "🔤 אותיות" },
      { id: "letter-resh", label: "אות ר׳ – הרכבת הרועשת", description: "רכבת רועשת עוברת ליד רחוב, רימונים ורוח — האות ר׳ נוסעת איתנו.", image: topicFamilyTrip, ageRange: "3-6", keywords: ["אות ר", "אלף בית", "למידה"], subCategory: "🔤 אותיות" },
      { id: "letter-shin", label: "אות ש׳ – השמש השמחה", description: "שמש שמחה מחייכת, שלג שקט ושירים — סיפור חם על האות ש׳.", image: topicCloudAdventure, ageRange: "3-6", keywords: ["אות ש", "אלף בית", "למידה"], subCategory: "🔤 אותיות" },
      { id: "letter-tav", label: "אות ת׳ – התרנגול התקתק", description: "תרנגול מתקתק עם תוף, תפוח ותמונה — סיום מושלם לאלף-בית עם אות ת׳.", image: topicFamilyTrip, ageRange: "3-6", keywords: ["אות ת", "אלף בית", "למידה"], subCategory: "🔤 אותיות" },
