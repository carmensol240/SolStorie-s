...
export const CHARACTER_SECTIONS: CharacterSection[] = [
  ...
  },
  {
    ...
    topics: [
      ...
      { id: "color-red", label: "צבע אדום", description: "אדום – צבע הלב, התפוח והאהבה. סיפור על הצבע האדום ועל כל הדברים היפים שהוא צובע.", image: topicRainParty, ageRange: "3-6", keywords: ["צבע אדום", "צבעים", "למידה"], subCategory: "🎨 צבעים" },
      { id: "color-blue", label: "צבע כחול", description: "כחול – צבע השמיים והים. סיפור על הצבע הכחול ועל הרגשת הרוגע והפלא שהוא מביא.", image: topicUnderwater, ageRange: "3-6", keywords: ["צבע כחול", "צבעים", "למידה"], subCategory: "🎨 צבעים" },
      { id: "color-yellow", label: "צבע צהוב", description: "צהוב – צבע השמש והבננה. סיפור על הצבע הצהוב ועל האושר והחום שהוא מביא.", image: topicBirthday, ageRange: "3-6", keywords: ["צבע צהוב", "צבעים", "למידה"], subCategory: "🎨 צבעים" },
      { id: "color-green", label: "צבע ירוק", description: "ירוק – צבע העשב והעץ. סיפור על הצבע הירוק ועל הטבע החי שסביבנו.", image: topicNatureSecrets, ageRange: "3-6", keywords: ["צבע ירוק", "צבעים", "למידה"], subCategory: "🎨 צבעים" },
      { id: "color-orange", label: "צבע כתום", description: "כתום – צבע הגזר והשקיעה. סיפור על הצבע הכתום ועל החיות והשמחה שבו.", image: topicFamilyTrip, ageRange: "3-6", keywords: ["צבע כתום", "צבעים", "למידה"], subCategory: "🎨 צבעים" },
      { id: "color-purple", label: "צבע סגול", description: "סגול – צבע הענבים והפרחים. סיפור על הצבע הסגול ועל הקסם שבו.", image: topicMagicCastle, ageRange: "3-6", keywords: ["צבע סגול", "צבעים", "למידה"], subCategory: "🎨 צבעים" },
      { id: "color-pink", label: "צבע ורוד", description: "ורוד – צבע הפלמינגו והממתקים. סיפור על הצבע הורוד ועל הרכות והחמימות שבו.", image: topicMagicalForest, ageRange: "3-6", keywords: ["צבע ורוד", "צבעים", "למידה"], subCategory: "🎨 צבעים" },
      { id: "color-white", label: "צבע לבן", description: "לבן – צבע הענן והשלג. סיפור על הצבע הלבן ועל הניקיון והשקט שהוא מביא.", image: topicCloudAdventure, ageRange: "3-6", keywords: ["צבע לבן", "צבעים", "למידה"], subCategory: "🎨 צבעים" },
      { id: "color-black", label: "צבע שחור", description: "שחור – צבע הלילה והכוכבים. סיפור על הצבע השחור ועל הסודות היפים של החושך.", image: topicFearOfDark, ageRange: "3-6", keywords: ["צבע שחור", "צבעים", "למידה"], subCategory: "🎨 צבעים" },
      { id: "shape-circle", label: "צורת עיגול", description: "עיגול – הצורה המושלמת. סיפור על העיגול ועל כל הדברים העגולים שסביבנו.", image: topicSuperheroes, ageRange: "3-6", keywords: ["עיגול", "צורות", "למידה"], subCategory: "🔷 צורות" },
      { id: "shape-square", label: "צורת ריבוע", description: "ריבוע – ארבע צלעות שוות. סיפור על הריבוע ועל הדברים המרובעים בחיינו.", image: topicZoo, ageRange: "3-6", keywords: ["ריבוע", "צורות", "למידה"], subCategory: "🔷 צורות" },
      { id: "shape-triangle", label: "צורת משולש", description: "משולש – שלוש פינות חדות. סיפור על המשולש ועל כל מה שיש לו שלוש צלעות.", image: topicSpaceHero, ageRange: "3-6", keywords: ["משולש", "צורות", "למידה"], subCategory: "🔷 צורות" },
      { id: "shape-rectangle", label: "צורת מלבן", description: "מלבן – ארוך ורחב. סיפור על המלבן ועל הדברים המלבניים שפוגשים בכל מקום.", image: topicFriendship, ageRange: "3-6", keywords: ["מלבן", "צורות", "למידה"], subCategory: "🔷 צורות" },
      { id: "shape-heart", label: "צורת לב", description: "לב – סמל האהבה. סיפור על צורת הלב ועל כל האהבה שהיא מייצגת.", image: topicBirthday, ageRange: "3-6", keywords: ["לב", "צורות", "למידה"], subCategory: "🔷 צורות" },
      { id: "shape-star", label: "צורת כוכב", description: "כוכב – הצורה של החלומות. סיפור על הכוכב ועל כל הקסם שבשמיים.", image: topicSpaceHero, ageRange: "3-6", keywords: ["כוכב", "צורות", "למידה"], subCategory: "🔷 צורות" },
    ],
  },
];