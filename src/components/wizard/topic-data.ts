...
export const CHARACTER_SECTIONS: CharacterSection[] = [
  {
    ...
    topics: [
      ...
      { id: "honesty", label: "אמירת אמת", description: "סיפור על כוחה של האמת: כשמישהו אמר דבר שלא היה נכון, הוא גילה שהלב שלו כבד מאוד – עד שהאמת יצאה החוצה ואיתה גם הקלה.", image: topicApologize, ageRange: "3-8", keywords: ["אמת", "כנות", "שקר", "אמון"] },
      { id: "respecting-elders", label: "כבוד למבוגרים", description: "סיפור על היחס החם לסבים, סבתות ומבוגרים: להקשיב, לעזור ולגלות שבכל קמט על הפנים מסתתר סיפור שלם.", image: topicGrandparentsNight, ageRange: "3-6", keywords: ["סבא", "סבתא", "כבוד", "מבוגרים", "דרך ארץ"] },
  ...
  },
  {
    ...
    topics: [
      ...
      { id: "cooperation", label: "שיתוף פעולה", description: "סיפור על הכוח של עבודת צוות: משימה שאחד לא יכול לבצע לבד הופכת אפשרית כשכולם מאחדים כוחות ומכוונים לאותה מטרה.", image: topicPlayingTogether, ageRange: "3-6", keywords: ["שיתוף פעולה", "צוות", "ביחד", "שותפות"] },
  ...
  },
  {
    ...
    topics: [
      ...
      { id: "honesty-edu", label: "אמירת אמת – מיומנות חברתית", description: "סיפור חברתי מובנה על כנות: ילדים רבים מרגישים לפעמים שקשה לומר את האמת. כשהאמת נאמרת בעדינות, היחסים נשארים חזקים.", image: topicApologize, ageRange: "3-8", keywords: ["אמת", "כנות", "מיומנות חברתית", "carol gray"] },
      { id: "cooperation-edu", label: "שיתוף פעולה בקבוצה", description: "סיפור חברתי על עבודת צוות: בכיתה או בגן, כשכל אחד תורם את חלקו, המשימה הגדולה הופכת לאפשרית ולמשמחת.", image: topicPlayingTogether, ageRange: "3-8", keywords: ["שיתוף פעולה", "קבוצה", "צוות", "carol gray"] },
      { id: "patience-edu", label: "סבלנות – להמתין בשקט", description: "סיפור חברתי על ויסות: יש רגעים שצריך לחכות – לתורנו, לתשובה, לסיום. נשימה עמוקה עוזרת לגוף ולמחשבות להירגע.", image: topicAngerCloud, ageRange: "3-8", keywords: ["סבלנות", "ויסות", "המתנה", "carol gray"] },
      { id: "politeness-edu", label: "אדיבות ודרך ארץ", description: "סיפור חברתי על נימוס: מילים כמו 'תודה' ו'בבקשה' הן לא רק כללים – הן הדרך שבה מראים לאחרים שרואים אותם ומכבדים אותם.", image: topicSharing, ageRange: "3-8", keywords: ["אדיבות", "נימוס", "דרך ארץ", "carol gray"] },
      { id: "respecting-elders-edu", label: "כבוד למבוגרים", description: "סיפור חברתי על יחס למבוגרים: להקשיב כשמדברים אליך, לחכות לתורך ולהגיד תודה – אלה דרכים שמראות כבוד ועושות טוב לכולם.", image: topicGrandparentsNight, ageRange: "3-8", keywords: ["כבוד", "מבוגרים", "דרך ארץ", "carol gray"] },
    ],
  },
];