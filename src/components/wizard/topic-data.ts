...
export const CHARACTER_SECTIONS: CharacterSection[] = [
  ...
  },
  {
    ...
    topics: [
      ...
      { id: "letter-zayin", label: "אות ז׳ – הזיקית הזריזה", description: "הרפתקה עם זיקית שמשנה צבעים, זברה זזה וזיקוקים — כולם מתחילים באות ז׳.", image: topicZoo, ageRange: "3-6", keywords: ["אות ז", "אלף בית", "למידה"], subCategory: "🔤 אותיות" },
      ...
      { id: "letter-samekh", label: "אות ס׳ – הסוס הסוער", description: "סוס סוער דוהר בסערה, עובר ליד ספינה וסלעים — האות ס׳ בכל מקום.", image: topicZoo, ageRange: "3-6", keywords: ["אות ס", "אלף בית", "למידה"], subCategory: "🔤 אותיות" },
      ...
      { id: "letter-tsadi", label: "אות צ׳ – הצב הצבעוני", description: "צב צבעוני צועד לאט ופוגש ציפור, צדפים וצעצועים — כולם עם אות צ׳.", image: topicZoo, ageRange: "3-6", keywords: ["אות צ", "אלף בית", "למידה"], subCategory: "🔤 אותיות" },
      { id: "letter-qof", label: "אות ק׳ – הקוף הקטן", description: "קוף קטן וקסום שאוהב קרקס, קשת וקליפות — הרפתקה עם האות ק׳.", image: topicZoo, ageRange: "3-6", keywords: ["אות ק", "אלף בית", "למידה"], subCategory: "🔤 אותיות" },
