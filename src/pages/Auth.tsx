    ...
    if (error) {
      ...
      if (userRole === "educator") {
        toast({
          ...
          description: "לאנשי החינוך, ממני באהבה – 3 סיפורים ראשונים במתנה! אני כאן כדי לעזור לכם להפוך כל סיפור למסע של למידה וצמיחה. 💜",
          duration: 6000,
        });
      } else {
        toast({
            ...
            {activeTab === "login" && (
              ...
              <form onSubmit={handleEmailSignIn} className="space-y-4">
                ...
                <button
                  ...
                  disabled={isSubmitting || !GOOGLE_SIGNIN_ENABLED}
                  className="w-full flex items-center justify-center gap-3 py-3 px-4 bg-white border-2 border-gray-300 rounded-full shadow-md hover:bg-gray-50 hover:shadow-lg transition-all text-base font-bold text-gray-700 disabled:opacity-50 disabled:cursor-not-allowed disabled:grayscale disabled:hover:bg-white disabled:hover:shadow-md"
                >
            ...
            {activeTab === "signup" && (
              ...
              <form onSubmit={handleEmailSignUp} className="space-y-4">
                ...
                <button
                  ...
                  onClick={handleGoogleSignIn}
                  disabled={isSubmitting || !signupTermsAccepted}
                  className="w-full flex items-center justify-center gap-3 py-3 px-4 bg-white border-2 border-gray-300 rounded-full shadow-md hover:bg-gray-50 hover:shadow-lg transition-all text-base font-bold text-gray-700 disabled:opacity-50 disabled:cursor-not-allowed"
                >
                  <svg className="w-5 h-5" viewBox="0 0 24 24">
                    <path fill="#4285F4" d="M22.56 12.25c0-.78-.07-1.53-.2-2.25H12v4.26h5.92c-.26 1.37-1.04 2.53-2.21 3.31v2.77h3.57c2.08-1.92 3.28-4.74 3.28-8.09z"/>
                    <path fill="#34A853" d="M12 23c2.97 0 5.46-.98 7.28-2.66l-3.57-2.77c-.98.66-2.23 1.06-3.71 1.06-2.86 0-5.29-1.93-6.16-4.53H2.18v2.84C3.99 20.53 7.7 23 12 23z"/>
