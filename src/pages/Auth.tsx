            ...
            {activeTab === "login" && (
              ...
              <form onSubmit={handleEmailSignIn} className="space-y-4">
                ...
                <button
                  ...
                  disabled={isSubmitting}
                  className="w-full flex items-center justify-center gap-3 py-3 px-4 bg-white border-2 border-gray-300 rounded-full shadow-md hover:bg-gray-50 hover:shadow-lg transition-all text-base font-bold text-gray-700 disabled:opacity-50"
                >
