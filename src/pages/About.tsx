    ...
    <div className="min-h-[100dvh] flex flex-col relative overflow-hidden" dir="rtl">
      ...
      <div className="flex-1 flex flex-col items-center px-6 pt-8 pb-16 max-w-lg mx-auto text-center relative z-10">
        ...
        <p className="text-base font-normal text-white leading-[1.6] text-right mb-5 px-1" style={{ textShadow: '0 1px 3px rgba(0,0,0,0.3)' }}>
          ...
          {" "}הנולדה מתוך רצון להעניק לבתי מרחב קסום, שמעמיד את עולמה הפנימי במרכז. מה שהתחיל כפיתוח אישי שנועד להעשיר את רגעי הדמיון שלה, הפך לטכנולוגיה פורצת דרך שמעניקה לכל ילד וילדה את הכוח ליצור ולהוביל את הסיפור הייחודי שלהם.
        </p>
        <p className="text-base font-normal text-white leading-[1.6] text-right mb-5 px-1" style={{ textShadow: '0 1px 3px rgba(0,0,0,0.3)' }}>
        ...
        <div className="space-y-4 mb-5 w-full">
          ...
          <div className="flex flex-col items-center gap-1.5">
            <span className="text-3xl">💜</span>
            <p className="text-base font-normal text-white leading-[1.6] text-right px-4" style={{ textShadow: '0 1px 3px rgba(0,0,0,0.3)' }}>
              <strong className="text-purple-200 font-black">סיפורים חברתיים מתוך הלב</strong> — הספרייה שלנו כוללת <strong className="text-purple-200 font-black">סיפורים חברתיים מתוך הלב</strong> — הספרייה שלנו כוללת למעלה מ-80 נושאים לבחירה מהיומיום שנבחרו בקפידה כדי לתווך סיטואציות רגשיות מורכבות בשילוב כלי NLP. שנבחרו בקפידה כדי לתווך סיטואציות רגשיות מורכבות בשילוב כלי NLP.
            </p>
          </div>
