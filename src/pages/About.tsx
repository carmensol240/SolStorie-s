  ...
  return (
    <div className="min-h-[100dvh] flex flex-col relative overflow-hidden" dir="rtl">
      ...
      <div className="flex-1 flex flex-col items-center px-6 pt-8 pb-16 max-w-lg mx-auto text-center relative z-10">
        ...
        <p className="text-sm text-white/75 leading-relaxed mb-5 px-1">
          הצורך שלי ליצור נבע מהרצון לתווך לסול סיטואציות חברתיות יומיומיות, ולעזור לה לבחור בשפה חיובית ובדרכי התמודדות נכונות אל מול התנהגויות פחות רצויות שהיא פוגשת בחוץ. דרך הסיפורים, אנחנו הופכים רגעים מאתגרים של חיקוי או קושי חברתי להזדמנות של למידה, העצמה ובחירה בטוב.
        </p>
