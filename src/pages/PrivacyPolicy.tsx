      ...
      <div className="container max-w-4xl mx-auto px-4 py-8 flex-1">
        ...
        <article className="bg-card rounded-2xl border shadow-sm p-6 mb-6">
          <div className="space-y-6 text-right leading-relaxed">
            ...
            <section>
              <h2 className="text-lg font-bold text-foreground mb-2">שימוש חינוכי ובית-ספרי</h2>
              <p className="text-muted-foreground leading-relaxed mb-3">
                אנו מכירים בכך שהשירות עשוי לשמש מחנכים, גננות ובתי ספר. בהתאם, אנו מחויבים לעקרונות הבאים:
              </p>
              <ul className="list-disc list-inside text-muted-foreground leading-relaxed space-y-2 mr-2">
                <li><strong>הסכמת הורים:</strong> שימוש בשירות במסגרת חינוכית מחייב הסכמה מוקדמת של הורי התלמידים. המוסד החינוכי אחראי לקבל הסכמה זו.</li>
                <li><strong>נתוני תלמידים:</strong> שמות הילדים וגילאיהם הם המידע המינימלי הנדרש ליצירת סיפורים. אנו לא אוספים מזהים נוספים כגון מספרי תעודת זהות, כתובות או מידע רפואי.</li>
                <li><strong>שמירת מידע:</strong> נתוני התלמידים נשמרים בהצפנה ואינם משותפים עם צדדים שלישיים. ניתן למחוק את כל הנתונים בכל עת.</li>
                ...
                <li><strong>אחריות המוסד:</strong> המוסד החינוכי המשתמש בשירות אחראי לוודא שהשימוש עומד במדיניות הגנת הפרטיות של המוסד ובחוקים המקומיים.</li>
              </ul>
            </section>
          </div>
        </article>
