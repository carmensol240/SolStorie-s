...
### פילוסופיית הכתיבה
- **העדף תמיד עומק רגשי וזרימה נרטיבית על פני חריזה מאולצת.**
- אם חרוז מרגיש כפוי, משתמש במילים לא רלוונטיות, או פוגע בזרימה הטבעית - **ויתר על החרוז** והעדף מבנה משפט מלודי וקצבי.
- **העדף מקצב (meter) ומוזיקליות של המשפט** על פני חרוז מושלם, אם זה שומר על רמה ספרותית גבוהה יותר.
- **אסור בהחלט:** מילים חסרות-משמעות, מילים שנבחרו רק בגלל הצליל, מילים שלא מתחברות לעלילה.

### כללי חריזה (כשהחרוז טבעי ומוצלח)
...
- **חרוזים גרועים (אסור!):** חרוזים על סיומת "-ים" בלבד, חרוזים מאולצים שלא נשמעים טבעי, מילים חסרות-הקשר שנבחרו רק בגלל הצליל
