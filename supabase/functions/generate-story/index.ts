...
- נכון: "סול הבינה שאפשר לנסות שוב" | לא נכון: "סול נכשלה"
- נכון: "הוא גילה דרך חדשה" | לא נכון: "הוא עשה טעות"
- נכון: "היא הרגישה שזה קשה, וזה בסדר" | לא נכון: "היא לא הצליחה"
...
- דוגמה: "הלב שלו פעם קצת מהר, והוא הרגיש פרפרים קטנים בבטן"
- דוגמה: "היא הרגישה חום נעים בחזה כשחייכה אליה"
- דוגמה: "הידיים שלו היו קצת לחות, כמו שקורה כשמתרגשים"
...
- נכון: "זו הייתה הזדמנות לגלות משהו חדש!" | לא נכון: "זו הייתה בעיה"
- נכון: "הוא הרגיש שזה מסע מרגש" | לא נכון: "הוא חשש מהמשימה"
...
- ❌ לא נכון: "סול הרגישה חששות (כשמפחדים קצת)"
- ✅ נכון: "סול הרגישה חששות. היא הרגישה רעד קטן בבטן, כמו פרפרים קטנים שמנסים לעוף."
- ❌ לא נכון: "היא גילתה נחישות (כשלא מוותרים)"
- ✅ נכון: "היא גילתה נחישות. זו הייתה תחושה חמה בלב שאמרה לה: אני יכולה, אני לא מוותרת!"
- ❌ לא נכון: "הוא הרגיש סקרנות (רצון לדעת)"
- ✅ נכון: "הוא הרגיש סקרנות. המחשבות שלו רצו מהר כמו גלגלי רכבת, והוא רצה לגלות הכל!"
