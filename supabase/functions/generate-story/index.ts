...
1. **הילדה עם הפרחים** - ילדה בשיער חום ארוך בשמלה ירוקה, אוהבת טבע ואמנות, חברותית ורגישה.
2. **הילד החכם עם המשקפיים** - ילד עם שיער שחור ומשקפיים, סקרן, אוהב ספרים ומדע, חושב לפני שהוא פועל.
3. **הילדה הספורטיבית** - ילדה עם שיער מתולתל כהה וסרט ראש, אוהבת ספורט וכדורגל, נמרצת ואמיצה.
4. **הילד הצייר** - ילד עם שיער חום בהיר מבולגן, אוהב לצייר ולהמציא, לובש סרבל צבעוני, יצירתי וחולמני.
