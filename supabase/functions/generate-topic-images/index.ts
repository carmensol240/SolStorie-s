...
const TOPIC_PROMPTS: Record<string, { filename: string; prompt: string }> = {
  ...
  "eating-with-cutlery": {
    ...
    prompt: `3D Disney Pixar cartoon animation style, 1:1 square aspect ratio. Vibrant saturated colors, cheerful warm lighting. A 4-year-old girl named Sol with tanned olive skin, dark wavy shoulder-length hair with natural volume, big round expressive brown eyes with sparkling highlights. She sits at a small colorful table, proudly and correctly holding a small shiny fork in one hand and a small spoon in the other over a stylized plate of colorful mini pasta pieces. She looks directly at the camera with a confident, proud, happy expression showing her new skill. Colorful detailed background with warm kitchen elements. Clean sharp rendering, rich textures, playful and whimsical atmosphere. Full upper body from waist up, character centered. Ultra high resolution. Negative prompt: ${NEGATIVE}, eating with hands, messy eating, dirty hands, floating food, photorealistic, dark, muted colors, cinematic bokeh`,
  },
  "playing-together": {
